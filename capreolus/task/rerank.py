...
def train(config, modules):
    ...
    reranker["extractor"].create(qids=best_search_run.keys(), docids=docids, topics=benchmark.topics[benchmark.query_type], qdocs=qdocs, extract_entities=benchmark.incorporate_entities)
    reranker.build()

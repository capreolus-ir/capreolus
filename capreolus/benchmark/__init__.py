...
class CodeSearchNetCorpus(Benchmark):
    ...
    def __init__(self, cfg):
        ...
        self.qrel_file = self.qrel_dir / config_name / f"{lang}.txt"
        self.topic_file = self.topic_dir / config_name / f"{lang}.txt"
        self.fold_file = self.fold_dir / config_name / f"{lang}.json"
